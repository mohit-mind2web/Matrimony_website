...
<main>
    ...
    <?php } ?>
            ...
            <form method="POST" action="">
                ...
                <input type="text" id="name" name="name" value="<?= htmlspecialchars($userdetails['fullname']) ?>" readonly><br><br>
                <label for="email">Your Email:</label><br>
                <input type="email" id="email" name="email" value="<?= htmlspecialchars($userdetails['email']) ?>" readonly><br><br>
