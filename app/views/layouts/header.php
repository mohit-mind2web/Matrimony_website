    ...
    <div class="sidebar">
      ...
      <ul>
       ...
       <?php if($_SESSION['role_id']==1):?>
        ...
        <li><a href="/admin/managereports" class="<?= $current_page == '/admin/managereports' ? 'active' : '' ?>"> <i class="fas fa-flag"></i>Manage Reports</a></li>
        <li><a href="/admin/managequeries" class="<?= $current_page == '/admin/managequeries' ? 'active' : '' ?>">  <i class="fas fa-envelope-open-text"></i>Manage Queries</a></li>
